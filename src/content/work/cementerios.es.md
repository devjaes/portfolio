...
description: |
  Sistema de gestión cementerial que modela el ciclo de vida de nichos — inventario, propiedad e herencia, pagos y procedimientos de inhumación. Entregado como Tech Lead sobre un equipo multifuncional. Next.js 15 + NestJS 11 + PostgreSQL + AWS S3.
tags:
  - Tech Lead
  - Next.js 15
  - NestJS
...
## Mi rol (Tech Lead)
Lideré el proyecto como **Tech Lead**. Mi aporte abarcó tanto la dirección técnica como la entrega: coordinar un equipo multifuncional (frontend, backend y pasantes), correr ceremonias, priorizar el backlog y gestionar el alcance, y ser el punto de integración — cada pull request se fusionó a través de mí. Trabajé junto a compañeros en backend y frontend.
